  ...
  document.getElementById("misseddates").disabled=true;
    ...
    document.querySelector(".dates").insertAdjacentHTML('beforeend',subtable);
        ...
        requiredentries.forEach(element => {
            const subentry=` <tr >
                                <td id="subrows"><b>${element.name} &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</b></td>
                                <td id="subrows"><b>${element.totpresent} &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp  &nbsp  &nbsp</b></td>
                                <td id="subrows"><b>${element.bunk} &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</b></td>   
                                <td id="subrows"><b>${element.absent} &nbsp<br></b></td>
                             </tr>
                        `
        ...
        document.querySelector(".leftside").style.height="auto";
    ...
    if(adddate.length>0&&addsubject!="Subject"){
      ...
      addsubject = addsubject.split(" ").join("") //remember to remove spaces between subject names
        ...
        .then(data => {
          ...
          document.querySelector(".rightside").style.height="auto";
